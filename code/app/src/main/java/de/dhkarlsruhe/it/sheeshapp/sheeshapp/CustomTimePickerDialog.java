...
/**
 * Created by d0272129 on 27.07.18.
 */
...
public class CustomTimePickerDialog extends TimePickerDialog{
        ...
        private TimePicker hTimerPicker;
        ...
        public void onAttachedToWindow() {
            ...
            try {
                ...
                hTimerPicker = findViewById(timePickerField.getInt(null));
                ...
                NumberPicker hourSponner = hTimerPicker.findViewById(fieldHour.getInt(null));
                hourSponner.setMinValue(0);
                hourSponner.setMaxValue(10);
